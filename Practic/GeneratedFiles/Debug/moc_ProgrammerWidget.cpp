...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProgrammerWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProgrammerWidget_t qt_meta_stringdata_ProgrammerWidget = {
    {
QT_MOC_LITERAL(0, 0, 16), // "ProgrammerWidget"
QT_MOC_LITERAL(1, 17, 16), // "addButtonHandler"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 19), // "reviseButtonHandler"
QT_MOC_LITERAL(4, 55, 14) // "changedHandler"

    },
    "ProgrammerWidget\0addButtonHandler\0\0"
    "reviseButtonHandler\0changedHandler"
};
...
void ProgrammerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ProgrammerWidget *_t = static_cast<ProgrammerWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addButtonHandler(); break;
        case 1: _t->reviseButtonHandler(); break;
        case 2: _t->changedHandler(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ProgrammerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ProgrammerWidget.data,
      qt_meta_data_ProgrammerWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ProgrammerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProgrammerWidget.stringdata0))
        return static_cast<void*>(const_cast< ProgrammerWidget*>(this));
    if (!strcmp(_clname, "Observer"))
        return static_cast< Observer*>(const_cast< ProgrammerWidget*>(this));
